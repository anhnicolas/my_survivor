        ...
        <div className="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div className="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-normal text-gray-500 dark:text-gray-400">{t('interactions')}</p>
                    </div>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2">
                <dl className="flex items-center">
                    <dt className="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">{t('meetings')}:</dt>
                    <dd className="text-gray-900 text-sm dark:text-white font-semibold">3,232</dd>
                </dl>
                <dl className="flex items-center justify-end">
                    <dt className="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">{t('percentage')}:</dt>
                    <dd className="text-gray-900 text-sm dark:text-white font-semibold">10.2%</dd>
                </dl>
            </div>
